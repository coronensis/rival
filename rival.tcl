#
# Project automation script for Rival
#
# Created for ISE version 14.6
#
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source rival.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "corecos.ucf"
   xfile add "corecos.vhd"

   # Set the Top Module as well...
   project set top "logic" "corecos"
...
proc set_process_props {} {
   ...
   project set "Output File Name" "corecos" -process "Generate IBIS Model"
